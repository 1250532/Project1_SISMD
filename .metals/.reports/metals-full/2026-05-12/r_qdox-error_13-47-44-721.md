error id: file://<WORKSPACE>/src/ApplyFilters.java
file://<WORKSPACE>/src/ApplyFilters.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[215,12]
...
public class ApplyFilters {
    ...
    static M@@easResult measureImpl(String name, Supplier<Color[][]> task, OperatingSystemMXBean osBean, int warmup, int trials, int availableProcessors) {
...
QDox parse error in file://<WORKSPACE>/src/ApplyFilters.java